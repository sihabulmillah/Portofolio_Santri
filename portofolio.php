      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 col-md-5 ">
            <!-- bar kiri -->
            <div class="progress">
              <div class="progress-bar" role="progressbar" style="transition:1s; width:<?= $data['skill1'] ?>%; background-color: rgba(134, 53, 53, 1);" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">HTML & CSS <span><?= $data['skill1'] ?>%</span></div>
            </div>
            <div class="progress">
              <div class="progress-bar" role="progressbar" style="width:<?= $data['skill2'] ?>%;background-color: rgba(53, 134, 61, 1);" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">MYSQL &
                PHP <span><?= $data['skill2'] ?>%</span></div>
            </div>
            <div class="progress">
              <div class="progress-bar" role="progressbar" style="width:<?= $data['skill3'] ?>%;background-color: rgba(132, 53, 134, 1);" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">BOOTSTRAP <span><?= $data['skill3'] ?>%</span></div>
            </div>
            <div class="progress">
              <div class="progress-bar" role="progressbar" style="width:<?= $data['skill4'] ?>%;background-color: rgba(143, 153, 26, 1);" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">LARAVEL <span><?= $data['skill4'] ?>%</span></div>
            </div>
            <div class="progress">
